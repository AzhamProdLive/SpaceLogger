...
module.exports = {
  ...
  category: 'Utility',
  perm: 'manageMessages',
  quickHelp: `Makes a log online of up to the last ${process.env.MESSAGE_ARCHIVE_SIZE || 100} messages in a channel. Does NOT delete any messages.`,  examples: `\`${process.env.GLOBAL_BOT_PREFIX}archive 5\` <- lowest amount possible
