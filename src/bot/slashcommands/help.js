      ...
      interaction.createMessage({
        embeds: [{
          ...
          fields: [{
            inline: true,
            name: 'Open Source',
            value: 'The new code is not open source, but the old code is available [here](https://github.com/curtisf/logger)'
          }, {
            inline: false,
            name: 'Privacy Policy',
      ...
      interaction.createMessage({
        embeds: [{
          ...
          fields: [{
            ...
            value: `${global.bot.user.username} cannot log messages upon deletion that it didn't see created first. Additionally, messages are kept for two days (see [old privacy policy](https://gist.github.com/curtisf/0598b0930c11363d24e29300cf21d572)), so messages older than two days old will not be logged upon deletion.`
          }],
          footer: getEmbedFooter(global.bot.user),
