...
-   **SpaceLogger**#7771 (1227650081923268638)
...
Data is stored in PostgreSQL, encrypted, and deleted after two days time or upon message deletion, or 3 weeks from creation, whichever comes first.

#### When a member joins a Server with the Bot present
Invite codes from Discord are stored short-term in Redis, encrypted, and deleted within 3 weeks.
...
Should you wish to enforce one of these rights, please email us at [azham@azhamspacestation.com](mailto:azham@azhamspacestation.com), we will strive to respond to your request within 30 days.
...
If you, the Server Manager, do not agree to the terms laid out in this document, you may remove the Bots from the server and stop using Services.
